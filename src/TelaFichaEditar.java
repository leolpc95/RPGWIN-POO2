...
public class TelaFichaEditar extends JFrame {
	...
	public TelaFichaEditar(FichaRepo fichaRepo, int id) {
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				}else { int confirm = JOptionPane.showConfirmDialog(btnEditar, "Deseja Realmente Editar?");
				if (confirm == 0) {
					JOptionPane.showMessageDialog(btnEditar, "Personagem Atualizado com sucesso!");
					fichaRepo.editar(personagem);
				}
		...
		this.personagem = this.fichaRepo.obter(this.id);
		txtNome.setText(this.personagem.getNome());
		txtSexo.setText(this.personagem.getSexo());
		txtClasse.setText(this.personagem.getClasse());
		txtHp.setText(Integer.toString(this.personagem.getHp()));
		txtOrigem.setText(this.personagem.getOrigem());
	}
}
